...
quiet_cmd__home_ashuu_Desktop_projects_bank_project_bankenv_src_node_v19_2_0_tools_v8_gypfiles_v8_gyp_v8_snapshot_target_run_mksnapshot = ACTION generating: "$(obj).$(TOOLSET)/$(TARGET)/geni/snapshot.cc" "$(obj).$(TOOLSET)/$(TARGET)/geni/embedded.S" $@
cmd__home_ashuu_Desktop_projects_bank_project_bankenv_src_node_v19_2_0_tools_v8_gypfiles_v8_gyp_v8_snapshot_target_run_mksnapshot = LD_LIBRARY_PATH=$(builddir)/lib.host:$(builddir)/lib.target:$$LD_LIBRARY_PATH; export LD_LIBRARY_PATH; cd $(srcdir)/tools/v8_gypfiles; mkdir -p $(obj).$(TOOLSET)/v8_snapshot/geni; "$(builddir)/mksnapshot" --turbo_instruction_scheduling "--target_os=linux" "--target_arch=x64" --startup_src "$(obj).$(TOOLSET)/v8_snapshot/geni/snapshot.cc" --embedded_variant Default --embedded_src "$(obj).$(TOOLSET)/v8_snapshot/geni/embedded.S" --no-native-code-counters
...
$(obj).$(TOOLSET)/$(TARGET)/geni/snapshot.cc $(obj).$(TOOLSET)/$(TARGET)/geni/embedded.S: 08428c4a15bc8ce8ceec2bc59bc77c602d118e47.intermediate
	@:
.INTERMEDIATE: 08428c4a15bc8ce8ceec2bc59bc77c602d118e47.intermediate
08428c4a15bc8ce8ceec2bc59bc77c602d118e47.intermediate: $(builddir)/mksnapshot FORCE_DO_CMD
	$(call do_cmd,touch)
	$(call do_cmd,_home_ashuu_Desktop_projects_bank_project_bankenv_src_node_v19_2_0_tools_v8_gypfiles_v8_gyp_v8_snapshot_target_run_mksnapshot)

all_deps += $(obj).$(TOOLSET)/$(TARGET)/geni/snapshot.cc $(obj).$(TOOLSET)/$(TARGET)/geni/embedded.S
action__home_ashuu_Desktop_projects_bank_project_bankenv_src_node_v19_2_0_tools_v8_gypfiles_v8_gyp_v8_snapshot_target_run_mksnapshot_outputs := $(obj).$(TOOLSET)/$(TARGET)/geni/snapshot.cc $(obj).$(TOOLSET)/$(TARGET)/geni/embedded.S
...
$(OBJS): | $(action__home_ashuu_Desktop_projects_bank_project_bankenv_src_node_v19_2_0_tools_v8_gypfiles_v8_gyp_v8_snapshot_target_run_mksnapshot_outputs)
...
$(obj).target/tools/v8_gypfiles/libv8_snapshot.a: | $(action__home_ashuu_Desktop_projects_bank_project_bankenv_src_node_v19_2_0_tools_v8_gypfiles_v8_gyp_v8_snapshot_target_run_mksnapshot_outputs)

# Preserve order dependency of special output on deps.
$(action__home_ashuu_Desktop_projects_bank_project_bankenv_src_node_v19_2_0_tools_v8_gypfiles_v8_gyp_v8_snapshot_target_run_mksnapshot_outputs): | $(obj).target/tools/v8_gypfiles/generate_bytecode_builtins_list.stamp $(obj).target/tools/v8_gypfiles/run_torque.stamp $(builddir)/mksnapshot $(obj).target/tools/v8_gypfiles/v8_maybe_icu.stamp $(obj).target/tools/v8_gypfiles/v8_compiler_for_mksnapshot.stamp
