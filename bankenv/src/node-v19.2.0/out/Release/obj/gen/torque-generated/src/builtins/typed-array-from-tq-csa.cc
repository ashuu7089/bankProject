...
TF_BUILTIN(TypedArrayFrom, CodeStubAssembler) {
  ...
  if (block40.is_used()) {
    ca_.Bind(&block40);
    tmp49 = CodeStubAssembler(state_).LoadJSTypedArrayLength(TNode<JSTypedArray>{tmp27});
    ca_.Goto(&block27, tmp49);
  }
  ...
  if (block20.is_used()) {
    ca_.Bind(&block20);
    tmp50 = ca_.CallStub<JSArray>(Builtins::CallableFor(ca_.isolate(), Builtin::kIterableToList), parameter0, tmp1, tmp14);
    tmp51 = FromConstexpr_intptr_constexpr_int31_0(state_, 24);
    tmp52 = CodeStubAssembler(state_).LoadReference<Number>(CodeStubAssembler::Reference{tmp50, tmp51});
    tmp53 = Convert_uintptr_Number_0(state_, TNode<Number>{tmp52});
    ca_.Goto(&block19, tmp53, tmp50);
  }
  ...
  if (block14.is_used()) {
    ...
    tmp54 = Convert_Number_uintptr_0(state_, TNode<UintPtrT>{phi_bb14_11});
    tmp55 = TypedArrayCreateByLength_0(state_, TNode<Context>{parameter0}, TNode<JSReceiver>{tmp6}, TNode<Number>{tmp54}, kBuiltinNameFrom_0(state_));
    tmp56 = CodeStubAssembler(state_).Word32BinaryNot(TNode<BoolT>{tmp9});
    ca_.Branch(tmp56, &block45, std::vector<compiler::Node*>{phi_bb14_11, phi_bb14_12}, &block46, std::vector<compiler::Node*>{phi_bb14_11, phi_bb14_12});
  }
  ...
  if (block45.is_used()) {
    ...
    tmp58 = CodeStubAssembler(state_).WordNotEqual(TNode<UintPtrT>{phi_bb45_11}, TNode<UintPtrT>{tmp57});
    ca_.Branch(tmp58, &block47, std::vector<compiler::Node*>{phi_bb45_11, phi_bb45_12}, &block48, std::vector<compiler::Node*>{phi_bb45_11, phi_bb45_12});
  }
  ...
  if (block47.is_used()) {
    ...
    CodeStubAssembler(state_).CallRuntime(Runtime::kTypedArrayCopyElements, parameter0, tmp55, phi_bb47_12, tmp54);
  ...
  if (block46.is_used()) {
    ...
    tmp59 = Cast_Callable_1(state_, TNode<Context>{parameter0}, TNode<Object>{tmp3}, &label60);
  ...
  if (block51.is_used()) {
    ...
    tmp61 = CodeStubAssembler(state_).LoadElementsKind(TNode<JSTypedArray>{tmp55});
    std::tie(tmp62, tmp63, tmp64) = GetTypedArrayAccessor_0(state_, TNode<Int32T>{tmp61}).Flatten();
    tmp65 = FromConstexpr_uintptr_constexpr_IntegerLiteral_0(state_, IntegerLiteral(false, 0x0ull));
    ca_.Goto(&block55, phi_bb51_11, phi_bb51_12, tmp65);
  }
  ...
  if (block55.is_used()) {
    ...
    tmp66 = CodeStubAssembler(state_).UintPtrLessThan(TNode<UintPtrT>{phi_bb55_19}, TNode<UintPtrT>{phi_bb55_11});
    ca_.Branch(tmp66, &block53, std::vector<compiler::Node*>{phi_bb55_11, phi_bb55_12, phi_bb55_19}, &block54, std::vector<compiler::Node*>{phi_bb55_11, phi_bb55_12, phi_bb55_19});
  }
  ...
  if (block53.is_used()) {
    ...
    tmp67 = Convert_Number_uintptr_0(state_, TNode<UintPtrT>{phi_bb53_19});
    tmp68 = CodeStubAssembler(state_).GetProperty(TNode<Context>{parameter0}, TNode<Object>{phi_bb53_12}, TNode<Object>{tmp67});
  ...
  if (block57.is_used()) {
    ...
    tmp69 = CodeStubAssembler(state_).Call(TNode<Context>{parameter0}, TNode<Object>{tmp59}, TNode<Object>{tmp5}, TNode<Object>{tmp68}, TNode<Object>{tmp67});
    ca_.Goto(&block59, phi_bb57_11, phi_bb57_12, phi_bb57_19, tmp69);
  }
  ...
  if (block58.is_used()) {
    ...
    ca_.Goto(&block59, phi_bb58_11, phi_bb58_12, phi_bb58_19, tmp68);
  }
...
tmp70 = TORQUE_CAST(CodeStubAssembler(state_).CallBuiltinPointer(Builtins::CallableFor(ca_.isolate(),ExampleBuiltinForTorqueFunctionPointerType(3)).descriptor(), tmp64, parameter0, tmp55, phi_bb59_19, phi_bb59_22));
    tmp71 = kStoreFailureArrayDetached_0(state_);
    tmp72 = CodeStubAssembler(state_).SmiEqual(TNode<Smi>{tmp70}, TNode<Smi>{tmp71});
    ca_.Branch(tmp72, &block61, std::vector<compiler::Node*>{phi_bb59_11, phi_bb59_12, phi_bb59_19, phi_bb59_19, phi_bb59_19}, &block62, std::vector<compiler::Node*>{phi_bb59_11, phi_bb59_12, phi_bb59_19, phi_bb59_19, phi_bb59_19});
  }
  ...
  if (block62.is_used()) {
    ...
    tmp74 = CodeStubAssembler(state_).UintPtrAdd(TNode<UintPtrT>{phi_bb62_19}, TNode<UintPtrT>{tmp73});
    ca_.Goto(&block55, phi_bb62_11, phi_bb62_12, tmp74);
  }
