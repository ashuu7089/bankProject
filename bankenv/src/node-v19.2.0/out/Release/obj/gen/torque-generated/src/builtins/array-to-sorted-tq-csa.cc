...
TF_BUILTIN(ArrayTimSortIntoCopy, CodeStubAssembler) {
  ...
  compiler::CodeAssemblerParameterizedLabel<Smi> block7(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
  compiler::CodeAssemblerParameterizedLabel<Smi, Smi, Smi> block15(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
  compiler::CodeAssemblerParameterizedLabel<Smi, Smi, Smi> block16(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
  compiler::CodeAssemblerParameterizedLabel<Smi> block19(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
  compiler::CodeAssemblerParameterizedLabel<Smi> block20(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
  compiler::CodeAssemblerParameterizedLabel<Smi> block8(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
  ...
  if (block9.is_used()) {
    ...
    tmp14 = CodeStubAssembler(state_).SmiLessThan(TNode<Smi>{phi_bb9_4}, TNode<Smi>{tmp13});
    ca_.Branch(tmp14, &block7, std::vector<compiler::Node*>{phi_bb9_4}, &block8, std::vector<compiler::Node*>{phi_bb9_4});
  }
  ...
  if (block7.is_used()) {
    ...
    std::tie(tmp15, tmp16, tmp17) = FieldSliceFixedArrayObjects_0(state_, TNode<FixedArray>{tmp10}).Flatten();
    tmp18 = Convert_intptr_Smi_0(state_, TNode<Smi>{phi_bb7_4});
    ...
    ca_.Branch(tmp21, &block15, std::vector<compiler::Node*>{phi_bb7_4, phi_bb7_4, phi_bb7_4}, &block16, std::vector<compiler::Node*>{phi_bb7_4, phi_bb7_4, phi_bb7_4});
  }
  ...
  TNode<BoolT> tmp28;
  if (block15.is_used()) {
    ca_.Bind(&block15, &phi_bb15_4, &phi_bb15_9, &phi_bb15_10);
    ...
    tmp28 = CodeStubAssembler(state_).TaggedIsNotSmi(TNode<Object>{tmp27});
    ca_.Branch(tmp28, &block19, std::vector<compiler::Node*>{phi_bb15_4}, &block20, std::vector<compiler::Node*>{phi_bb15_4});
  }
  ...
  if (block16.is_used()) {
    ca_.Bind(&block16, &phi_bb16_4, &phi_bb16_9, &phi_bb16_10);
    CodeStubAssembler(state_).Unreachable();
  }
  ...
  if (block20.is_used()) {
    ...
    tmp30 = CodeStubAssembler(state_).SmiAdd(TNode<Smi>{phi_bb20_4}, TNode<Smi>{tmp29});
    ca_.Goto(&block9, tmp30);
  }
  ...
  if (block8.is_used()) {
    ...
    tmp31 = CopyWorkArrayToNewFastJSArray_0(state_, TNode<Context>{parameter0}, TNode<SortState>{parameter1}, ElementsKind::PACKED_SMI_ELEMENTS, TNode<Smi>{tmp0});
  ...
  if (block4.is_used()) {
    ca_.Bind(&block4);
    tmp32 = CopyWorkArrayToNewFastJSArray_0(state_, TNode<Context>{parameter0}, TNode<SortState>{parameter1}, ElementsKind::PACKED_ELEMENTS, TNode<Smi>{tmp0});
  ...
  if (block2.is_used()) {
    ca_.Bind(&block2);
    tmp33 = CopyWorkArrayToNewJSArray_0(state_, TNode<Context>{parameter0}, TNode<SortState>{parameter1}, TNode<Smi>{tmp0});
